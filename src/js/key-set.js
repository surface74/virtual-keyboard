export default class KeySet {
  get keys() {
    return {
      ...
      7: {
        keyRu: '7', keyRuShift: '?', keyEn: '8', keyEnShift: '', code: 'Digit7', keyCode: 56,
      },
      8: {
        keyRu: '8', keyRuShift: '*', keyEn: '8', keyEnShift: '', code: 'Digit8', keyCode: 57,
      },
      9: {
      ...
      11: {
        keyRu: '-', keyRuShift: '_', keyEn: '-', keyEnShift: '', code: 'Minus', keyCode: 189,
      },
      12: {
